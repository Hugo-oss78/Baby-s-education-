...
- **Confidentialité** : toutes les données restent dans le navigateur de l'appareil (rien n'est envoyé sur internet). Utiliser ⚙️ → *Exporter / Importer* pour sauvegarder ou copier les données sur un autre téléphone.
